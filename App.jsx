...
const SM = {
  // AI・GPU
  NVDA:{n:"エヌビディア",      p:177, v:312000000,rsi:72,perf:{"1y":215,"6m":78,"3m":35,"1m":14.2,"10d":5.8,"1d":1.8},d:"AIアクセラレータGPUで市場シェア80%超。CUDAエコシステムでAI学習の標準基盤。"},
  AMD: {n:"AMD",               p:200, v:89000000, rsi:54,perf:{"1y":95,"6m":34,"3m":15,"1m":5.1,"10d":2.1,"1d":0.6},d:"CPUとGPU双方で競合力を持つ唯一のメーカー。MI300XでAI推論市場に進出中。"},
  INTC:{n:"インテル",           p:46,  v:198000000,rsi:38,perf:{"1y":-28,"6m":-14,"3m":-7,"1m":-2.2,"10d":-0.9,"1d":-0.2},d:"x86 CPUの発明者。ファウンドリ事業再建とAI PCチップで巻き返しを図る。"},
  ...
  // 半導体装置・設計
  AVGO:{n:"ブロードコム",       p:320,v:42000000, rsi:68,perf:{"1y":125,"6m":45,"3m":21,"1m":7.4,"10d":3.2,"1d":0.8},d:"カスタムAIチップ・ネットワーク半導体を開発。Apple・Google・Metaと大型契約。"},
  ...
  AMAT:{n:"アプライド・マテリアルズ",p:28,v:12000000,rsi:58,perf:{"1y":62,"6m":22,"3m":10,"1m":3.4,"10d":1.4,"1d":0.4},d:"半導体製造装置・材料の世界最大メーカー。AIチップ製造に不可欠な先端装置を提供。"},
  LRCX:{n:"ラムリサーチ",       p:234, v:4800000,  rsi:62,perf:{"1y":68,"6m":24,"3m":10,"1m":3.8,"10d":1.5,"1d":0.4},d:"半導体エッチング・堆積装置メーカー。先端チップ製造に不可欠な装置で高シェア。"},
  ...
  MU:  {n:"マイクロン",         p:412, v:24000000, rsi:61,perf:{"1y":82,"6m":28,"3m":12,"1m":4.4,"10d":1.8,"1d":0.5},d:"HBM3E需要でAI向けDRAM・NAND市場をリード。データセンター向けが急拡大中。"},
  ...
  SMCI:{n:"スーパーマイクロ",    p:38, v:18000000, rsi:48,perf:{"1y":148,"6m":32,"3m":-8,"1m":-4.1,"10d":-2.2,"1d":-0.8},d:"AIサーバーラックの設計・製造大手。NVIDIAのGPUを搭載するサーバーで急成長。"},
  ...
  // ビッグテック
  MSFT:{n:"マイクロソフト",     p:393, v:41000000,rsi:55,perf:{"1y":58,"6m":21,"3m":10,"1m":3.4,"10d":1.2,"1d":0.4},d:"OpenAIへの大規模投資でCopilotをOffice・Azure全製品に統合。エンタープライズAI市場を主導。"},
  GOOGL:{n:"アルファベット",    p:312, v:145000000,rsi:58,perf:{"1y":49,"6m":18,"3m":8.4,"1m":2.9,"10d":1.0,"1d":0.3},d:"GeminiモデルでOpenAIに対抗。検索・GCP・YouTubeにAIを統合展開中。"},
  META:{n:"メタ",              p:645, v:134000000,rsi:65,perf:{"1y":182,"6m":62,"3m":28,"1m":9.8,"10d":4.2,"1d":1.1},d:"Llama系オープンソースLLMを公開。AI広告でFacebook・Instagram収益が急増。"},
  AMZN:{n:"アマゾン",          p:210, v:124000000,rsi:64,perf:{"1y":82,"6m":33,"3m":15,"1m":5.0,"10d":1.7,"1d":0.4},d:"EC・AWS・広告・Prime。AWSはAIインフラ需要で高成長を維持。Bedrockで企業向けAIを展開。"},
  ...
  // エンタープライズSaaS
  ORCL:{n:"オラクル",          p:145, v:14000000, rsi:68,perf:{"1y":88,"6m":32,"3m":14,"1m":5.6,"10d":2.2,"1d":0.7},d:"クラウドDB・ERP・AIインフラで急成長中。NVIDIAとの大型クラウドGPU契約が注目。"},
  ...
  PLTR:{n:"パランティア",      p:137,  v:42000000, rsi:63,perf:{"1y":182,"6m":68,"3m":32,"1m":11.2,"10d":4.8,"1d":1.1},d:"政府・軍向けビッグデータ分析プラットフォーム。AIPで商業部門も急成長。"},
  ...
  // EV・自動車
  TSLA:{n:"テスラ",            p:402, v:412000000,rsi:42,perf:{"1y":-24,"6m":-18,"3m":8.2,"1m":-3.4,"10d":-2.1,"1d":-0.5},d:"EV・蓄電池・太陽光パネルを垂直統合するエネルギー企業。FSDで自動運転ソフト収益化を目指す。"},
  ...
  // バイオ・製薬
  LLY: {n:"イーライリリー",     p:1052, v:18000000, rsi:74,perf:{"1y":148,"6m":59,"3m":27,"1m":9.2,"10d":4.0,"1d":1.0},d:"GLP-1系肥満・糖尿病治療薬(Mounjaro/Zepbound)で急成長。需要が供給を大幅超過中。"},
  NVO: {n:"ノボノルディスク",   p:72, v:8800000,  rsi:62,perf:{"1y":68,"6m":24,"3m":10,"1m":3.8,"10d":1.5,"1d":0.4},d:"Ozempic・Wegovy（セマグルチド）で肥満治療市場をリード。"},
  ABBV:{n:"アッヴィ",           p:320, v:8400000,  rsi:58,perf:{"1y":22,"6m":8,"3m":3.4,"1m":1.2,"10d":0.5,"1d":0.2},d:"Humira後継品SkyriqとリンヴォックでHumiraの特許切れを乗り越え成長軌道を維持中。"},
  ...
  AMGN:{n:"アムジェン",         p:388, v:8400000,  rsi:52,perf:{"1y":12,"6m":4,"3m":1.8,"1m":0.6,"10d":0.2,"1d":0.1},d:"バイオ医薬品パイオニア。抗炎症薬・骨粗鬆症治療薬に加え肥満治療薬の開発も本格化。"},
  // メドテック
  ...
  WFC: {n:"ウェルズ・ファーゴ",  p:81,  v:28000000, rsi:52,perf:{"1y":48,"6m":17,"3m":7.2,"1m":2.5,"10d":1.0,"1d":0.3},d:"米国第3位の銀行。スキャンダル後の立て直しが進み規制当局の資産上限解除への期待が高まる。"},
  GS:  {n:"ゴールドマン・サックス",p:860,v:8400000,  rsi:64,perf:{"1y":42,"6m":15,"3m":6.4,"1m":2.2,"10d":0.9,"1d":0.3},d:"投資銀行・証券・資産管理の世界最大手。IPO・M&A市場の回復とAI関連投資で恩恵を受ける。"},
  ...
  // フィンテック・決済
  V:   {n:"ビザ",               p:320, v:8400000,  rsi:62,perf:{"1y":18,"6m":6,"3m":2.8,"1m":1.0,"10d":0.4,"1d":0.1},d:"世界最大の決済ネットワーク。Visaネットワークで世界200カ国以上の決済を処理する。"},
  MA:  {n:"マスターカード",      p:517, v:4800000,  rsi:64,perf:{"1y":22,"6m":8,"3m":3.4,"1m":1.2,"10d":0.5,"1d":0.2},d:"グローバル決済ネットワーク第2位。デジタルペイメントとB2B決済に注力。"},
  ...
  RTX: {n:"RTX",               p:203,  v:12000000, rsi:62,perf:{"1y":34,"6m":14,"3m":6.3,"1m":2.0,"10d":1.0,"1d":-0.1},d:"ミサイル・レーダー・ジェットエンジンを製造。ウクライナ支援でパトリオットミサイル需要が急増。"},
  ...
  RKLB:{n:"ロケット・ラボ",      p:69,  v:28000000, rsi:62,perf:{"1y":128,"6m":48,"3m":22,"1m":8.4,"10d":3.4,"1d":1.0},d:"小型衛星打ち上げロケット「Electron」と宇宙部品製造を手掛ける宇宙新興企業。"},
  // EC・小売
  ...
  // ヘルスケア・保険
  UNH: {n:"ユナイテッドヘルス",  p:293, v:14000000, rsi:58,perf:{"1y":14,"6m":6,"3m":2.6,"1m":0.9,"10d":0.4,"1d":0.1},d:"米国最大の医療保険会社。OptumのデータアナリティクスとヘルステックでAI医療サービスも拡大中。"},
  JNJ: {n:"J&J",               p:248, v:12000000, rsi:48,perf:{"1y":8,"6m":3,"3m":1.5,"1m":0.5,"10d":0.2,"1d":0.0},d:"医薬品・医療機器のコングロマリット。消費者向け事業をKenvueとして分社化しファーマ・メドテックに集中。"},
  ...
  VZ:  {n:"ベライゾン",         p:50,  v:28000000, rsi:48,perf:{"1y":12,"6m":4,"3m":1.8,"1m":0.6,"10d":0.2,"1d":0.1},d:"米国最大手通信会社。5Gインフラ投資とFiOS（光ファイバー）拡大で競争力強化中。"},
  NFLX:{n:"ネットフリックス",    p:96, v:8800000,  rsi:68,perf:{"1y":68,"6m":24,"3m":10,"1m":3.8,"10d":1.5,"1d":0.4},d:"世界最大の定額動画配信(SVOD)。広告付き低価格プランとパスワード共有取り締まりで収益改善。"},
  ...
  MSTR:{n:"MicroStrategy",        p:130, v:28000000, rsi:62,perf:{"1y":342,"6m":128,"3m":52,"1m":18,"10d":6.8,"1d":2.2},d:"法人BTCトレジャリー戦略の先駆者。BTCを主要資産として大量購入・保有する事実上のBTC投資会社。"},
...
export default function App(){
  ...
  async function runBulkUpdate(){
    ...
    const BATCH = 20; // 1回のAPIコールで処理する銘柄数
    ...
    for(let i=0; i<tickers.length; i+=BATCH){
      ...
      const prompt = `以下の米国株ティッカーの最新情報をJSON形式で返してください。
各銘柄について: 現在株価(p)、RSI14日足(rsi)、騰落率%(1d,10d,1m,3m,6m,1y)を含めてください。
騰落率はプラス/マイナスの数値で答えてください。

ティッカー: ${batch.join(",")}

必ず以下のJSON形式のみで返してください（説明文不要）:
{
  "TICKER1": {"p":123.45,"rsi":58,"perf":{"1d":0.5,"10d":2.1,"1m":5.3,"3m":12.4,"6m":28.1,"1y":72.5}},
  "TICKER2": {...}
}`;
      ...
      try{
        ...
        if(match){
          ...
          for(const [tk, val] of Object.entries(parsed)){
            if(SM[tk] && val.p && val.p>0){
              newOverride[tk] = {p:val.p, rsi:val.rsi||SM[tk].rsi, perf:val.perf||SM[tk].perf};
              totalUpdated++;
            }
          }
          setBulkLog(prev=>[...prev, `✅ ${batch.join(",")} — ${Object.keys(parsed).length}件取得`]);
        } else {
          setBulkLog(prev=>[...prev, `⚠️ ${batch[0]}〜 — パース失敗`]);
        }
      } catch(e){
