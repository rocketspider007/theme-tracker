...
const SM = {
  ...
  XYZ: {n:"ブロック",           p:58,  v:18000000, rsi:46,perf:{"1y":-18,"6m":-7,"3m":12.4,"1m":4.1,"10d":1.8,"1d":0.4},d:"中小企業向け決済端末と個人向けCash Appを運営。BitcoinウォレットとLN統合も推進中。"},
  ...
  // NASDAQ 代表的グロース銘柄
  TSM: {n:"TSMC ADR",            p:375, v:18000000, rsi:62,perf:{"1y":68,"6m":24,"3m":10,"1m":3.8,"10d":1.5,"1d":0.4},d:"世界最大の半導体受託製造会社。NVDIA・AAPL向けの最先端チップを独占的に製造するTSMCのADR。"},
  ...
  // ─── 宇宙・スペーステック ───
  ACHR:{n:"Archer Aviation",            p:8,   v:4200000,  rsi:52,perf:{"1y":82,"6m":32,"3m":14,"1m":4.8,"10d":2.0,"1d":0.6},d:"質量分析・化学検知センサー技術を持つ宇宙・空港セキュリティ向けハードウェア企業。"},
  ...
  VKTX:{n:"Viking Therapeutics",     p:38,  v:3800000,  rsi:58,perf:{"1y":112,"6m":42,"3m":18,"1m":6.8,"10d":2.8,"1d":0.9},d:"デンマーク発の肥満・GLP-1関連薬剤を開発するバイオテック。次世代ペプチド系薬剤を研究中。"},
...
const THEMES = [
  ...
  { id:"crypto",   name:"クリプト・Web3",          emoji:"🪙", color:"#F0B90B",
    ...
    stocks:["COIN","MSTR","MARA","RIOT","XYZ","HOOD","AFRM"] },
  ...
  { id:"glp1",      name:"GLP-1・肥満治療",        emoji:"💉", color:"#FF88CC",
    ...
    stocks:["LLY","NVO","HIMS","HALO","VKTX","VRTX"] },
  ...
  { id:"fintech",   name:"フィンテック・決済",      emoji:"💳", color:"#FF8844",
    ...
    stocks:["V","MA","PYPL","XYZ","AFRM","COIN","SOFI","HOOD","UPST","NU"] },
  ...
  { id:"space",     name:"宇宙・衛星",              emoji:"🚀", color:"#FF7777",
    ...
    stocks:["RKLB","ASTS","LUNR","SPCE","PLTR","RTX","NOC","ACHR"] },
  ...
  { id:"chinaadrs", name:"中国ADR・新興市場",         emoji:"🐉", color:"#FF6644",
    ...
    stocks:["BABA","BIDU","PDD","JD","NTES","TSM"] },
];
...
const THEMES_LIVE = useMemo(()=>{
  ...
  const activeTheme=activeId?THEMES_LIVE.find(t=>t.id===activeId):null;
